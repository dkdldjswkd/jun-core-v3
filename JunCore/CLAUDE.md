...
**별도 문서로 분리됨**: [docs/JobSystem_Architecture.md](docs/JobSystem_Architecture.md)

핵심 개념:
- Job은 JobObject에 속함 (LogicThread가 아님)
- JobObject가 어느 LogicThread에 있는지에 따라 Job 실행 위치 결정
- Scene 이동 시 LogicThread도 자동 이동